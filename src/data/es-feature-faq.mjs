...
export const featureFaqItemsEs = [
  ...
  // ─── MCP / Developers ─────────────────────────────────────────────────
  {
    ...
    aHtml:
      'Dos, para cosas distintas. La API para webs lleva tu propia cartera de PropertyList a tu web (una clave REST que creas, rotas y revocas en tu cuenta, 35 créditos al mes por toda la red, gratis para tus propios anuncios). El MCP en propertylist.es/mcp es un servidor de Model Context Protocol para datos inmobiliarios de España y Portugal: los agentes de IA pueden buscar en el mercado (search_properties, find_properties_by_description, autocomplete_location, get_property, area_market_summary, list_agencies), enviar una consulta cualificada directamente a la agencia del anuncio (submit_enquiry) y, con una clave de agencia gratis, trabajar tu propio CRM: anuncios, leads, pipeline, contactos y notas. <a href="https://propertylist.es/api-docs" rel="noopener">Docs de la API para webs</a>, <a href="https://propertylist.es/mcp?lang=es" rel="noopener">MCP</a>.',
  },
  {
    id: 'ai-tools',
    q: '¿Puedo conectar PropertyList a herramientas de IA como Claude, Cursor o Perplexity?',
    aHtml:
      'Sí. El MCP conecta los datos en directo de PropertyList a cualquier cliente compatible con MCP - Claude, Cursor, Zed, Perplexity y cualquier herramienta de Model Context Protocol - para que un agente de IA busque en tu mercado por ti. Instalación vía Claude Desktop config, adaptador npx o el endpoint JSON-RPC directo. La búsqueda estructurada funciona sin clave; el matcher de IA en lenguaje natural y tus herramientas de CRM necesitan una clave de agencia, y la clave se emite automáticamente: pulsa Conectar en Claude o ChatGPT e inicia sesión con tu cuenta de PropertyList.',
  },
  {
    id: 'mcp-free',
    q: '¿El MCP es gratis?',
    aHtml:
      'Cuatro niveles. Público: gratis, sin registro ni clave, búsqueda estructurada, autocompletado de ubicaciones, detalle completo de anuncios y resúmenes de mercado por zona a 60 solicitudes por minuto. Agente: una clave gratis que se emite automáticamente al iniciar sesión con tu cuenta de PropertyList, que activa el matcher de IA en lenguaje natural y tus propias herramientas de CRM (anuncios, leads, pipeline, contactos y notas), con 200 búsquedas de IA al mes incluidas, después 1 crédito por cada 10 búsquedas de la cartera de tu agencia, a 600 solicitudes por minuto. Pro: 50 créditos al mes de tu cartera de créditos, que levanta los límites de volumen; mejora directamente en el CRM en Ajustes y vuelve a la clave gratis cuando quieras. Enterprise: a medida, por contrato, para bancos, tasadores, portales y equipos de producto de IA. <a href="https://propertylist.es/mcp?lang=es" rel="noopener">propertylist.es/mcp</a>.',
  },
