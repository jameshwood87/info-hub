...
## IMPORTANT: Codebase Intelligence Instructions for propertylist-website
...
### Architecture
This is a mock documentation page generated by repowise's MockProvider. This module provides core functionality for the sample repository. See the source file for the full symbol list. ---
*Mock call #86*
### Key Modules
| Module | Purpose | Owner |
|--------|---------|-------|
| `src` | This is a mock documentation page generated by repowise's MockProvider | — |
| `tests` | This is a mock documentation page generated by repowise's MockProvider | — |
| `root` | This is a mock documentation page generated by repowise's MockProvider | — |
| `scripts` | This is a mock documentation page generated by repowise's MockProvider | — |
### Entry Points
- `src/pages/api/admin/kb-pages/index.ts`
- `src/pages/api/admin/kb-redirects/index.ts`
### Tech Stack
...
|------|-------|-------------|-------|
| `src/middleware.ts` | 99.0th %ile | 2 | PropertyList Agent |
| `vitest.config.ts` | 98.0th %ile | 1 | PropertyList Agent |
| `tests/vitest.setup.ts` | 97.0th %ile | 1 | PropertyList Agent |
| `tests/neighbourhood-slug.test.ts` | 96.0th %ile | 1 | PropertyList Agent |
| `tests/neighbourhood-portal.test.ts` | 94.9th %ile | 1 | PropertyList Agent |
